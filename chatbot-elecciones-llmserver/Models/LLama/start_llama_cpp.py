...
class Settings(BaseSettings):
    model: str = '/Users/tsstimfd/MyDocuments/NLP/ggml-q4-models/models/gpt4all/7b/gpt4all-lora-quantized.bin'
    n_ctx: int = 2048
    n_batch: int = 8
...
def create_completion(
    ...
    completion: llama_cpp.Completion = completion_or_chunks
    #print(completion)
    return completion
...
uvicorn.run(
    app, host=os.getenv("HOST", "localhost"), port=int(os.getenv("PORT", 8020))
)